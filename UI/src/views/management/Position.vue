...
import Form from './PositionForm.vue'
...
function edit(item: { id: string }) {
    router.push({ name: 'positionForm', params: { id : item ? item.id : EmptyObjectId} })
}
...
<template>
    ...
    <DataTable v-show="!$route.params.id" :key="dataTableKey" api-name="position" header="Pozisyonlar"  @itemselect="edit($event)">
